...
return [
    'routes' => [
        ...
        'provider-paket' => 'Dashboard/pages/provider/provider-paket.html',
        'provider-produk' => 'Dashboard/pages/provider/provider-produk.html',
        'provider-produk-tambah' => 'Dashboard/pages/provider/provider-produk-tambah.html',
        'provider-produk-edit' => 'Dashboard/pages/provider/provider-produk-edit.html',
        ...
        'paket-benefit' => 'Dashboard/pages/provider/paket-benefit.html',
        'paket-informasi' => 'Dashboard/pages/provider/paket-informasi.html',
        'paket-skema' => 'Dashboard/pages/provider/paket-skema.html',
    ...
    'breadcrumbs' => [
        ...
        'provider-paket' => 'Provider > Daftar Paket',
        'provider-produk' => 'Provider > Daftar Produk Paket',
        'provider-produk-tambah' => 'Provider > Produk Paket > Tambah',
        'provider-produk-edit' => 'Provider > Produk Paket > Edit',
        ...
        'paket-benefit' => 'Provider > Paket > Benefit',
        'paket-informasi' => 'Provider > Paket > Informasi',
        'paket-skema' => 'Provider > Paket > Skema',
